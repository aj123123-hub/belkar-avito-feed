...
alternate:
  - https://yandex.ru/dev/autoru/doc/ru/reference/auction-cars-used-promo-campaign-pause.md
---
> **Documentation Index:** Fetch the complete configuration index at https://yandex.ru/dev/autoru/doc/ru/llms.txt


# PUT /dealer/auction/cars/used/promo-campaign/{campaign_id}/pause

Позволяет временно приостановить рекламную кампанию.

## Формат запроса {#input}

```
PUT https://apiauto.ru/1.0/dealer/auction/cars/used/promo-campaign/{[campaign_id](*campaign_id)}/pause
```
...
> ```http
> curl -X 'PUT' \
> 'http://apiauto.ru/1.0/dealer/auction/cars/used/promo-campaign/1/pause' \
