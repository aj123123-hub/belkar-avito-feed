...
alternate:
  - https://yandex.ru/dev/autoru/doc/ru/reference/auction-cars-used-promo-campaign-delete.md
---
> **Documentation Index:** Fetch the complete configuration index at https://yandex.ru/dev/autoru/doc/ru/llms.txt


# DELETE /dealer/auction/cars/used/promo-campaign/{campaign_id}

Позволяет удалить рекламную кампанию.

## Формат запроса {#input}

```
DELETE https://apiauto.ru/1.0/dealer/auction/cars/used/promo-campaign/{[campaign_id](*campaign_id)}
```
