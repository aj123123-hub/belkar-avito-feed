...
alternate:
  - https://yandex.ru/dev/autoru/doc/ru/reference/auction-offer-place-bid.md
---
> **Documentation Index:** Fetch the complete configuration index at https://yandex.ru/dev/autoru/doc/ru/llms.txt


# POST /dealer/auction/offer/{offer_id}/place-bid 

Делает ставку по объявлению.

## Формат запроса {#input}

```
GET https://apiauto.ru/1.0/dealer/auction/offer/{[offer_id](*offer_id)}/place-bid
```
...
##bid##
|
Новая ставка аукциона в копейках.
||
|#

</div>

Не указывайте `"previous_bid": {integer}`, если автомобиль еще не участвовал в аукционе и у него нет предыдущей ставки. В таком случае тело запроса должно выглядеть так:
...
>  "previous_bid": 470000, \ 
>  "bid": 460000 \ 
>  }' 'https://apiauto.ru/1.0/dealer/auction/offer/{offer_id}/place-bid'
> ```
> 
> 
> Ответ:
