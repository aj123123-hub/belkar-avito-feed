...
alternate:
  - https://yandex.ru/dev/autoru/doc/ru/reference/put-calltracking-call-tag.md
---
> **Documentation Index:** Fetch the complete configuration index at https://yandex.ru/dev/autoru/doc/ru/llms.txt


# PUT /calltracking/call/tag

Добавляет произвольные теги к звонку.

## Формат запроса {#input}

```
PUT https://apiauto.ru/1.0/calltracking/call/tag
```
...
{% include notitle [tags](../_includes/params/put-calltracking-call-tag-514b9cf0162f.md#tags) %}
...
> 
> ```http
> curl -i -X PUT 'https://apiauto.ru/1.0/calltracking/call/tag' \ 
