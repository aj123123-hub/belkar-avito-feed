...
alternate:
  - https://yandex.ru/dev/autoru/doc/ru/reference/user-offers-category-offer-id-products.md
---
...
Подключает услуги к объявлению.

## Формат запроса {#input}

```
POST https://apiauto.ru/1.0/user/offers/{[category](*category)}/{[offerID](*offerID)}/products
```
...
#|
|| ##products##[*](*req) | Список услуг, которые необходимо подключить. Массив объектов. ||
|#
...
:   #|
    ...
    #|
    || ##badges## | Массив рекламных текстов для услуги `all_sale_badge`. Можно передать не более трех элементов в массиве. ||
    |#
...
> 
> ```http
> curl -i -X POST 'https://apiauto.ru/1.0/user/offers/cars/1022557788-4a6efe8b/products' -H 'x-authorization: 2dtrer432...' -d '{"products":[{"code": "all_sale_fresh"}]}' -H 'Accept: application/json' -H 'Content-Type: application/json' -H 'x-session-id: 112_aoR02Tpv...'
> ```
> 
> 
> Ответ:
...
> HTTP/1.1 200 OK
> Server: nginx
> Date: Fri, 15 Jun 2018 14:30:59 GMT
