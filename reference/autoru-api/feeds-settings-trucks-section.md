...
alternate:
  - https://yandex.ru/dev/autoru/doc/ru/reference/feeds-settings-trucks-section.md
---
> **Documentation Index:** Fetch the complete configuration index at https://yandex.ru/dev/autoru/doc/ru/llms.txt


# POST /feeds/settings/trucks/{trucks_category}/{section}

Добавляет настройки прайс-листа для категории ТС «Коммерческие ТС». Операция используется, если вы автоматически загружаете прайс-листы на сайт для актуализации объявлений.

## Формат запроса {#input}

```
POST https://apiauto.ru/1.0/feeds/settings/trucks/[trucks_category](*truck_category)/[section](*section)
```
...
> 
> ```http
> curl -i -X POST 'https://apiauto.ru/1.0/feeds/settings/trucks/TRUCK/NEW' \
