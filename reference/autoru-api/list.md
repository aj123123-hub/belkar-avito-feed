...
alternate:
  - https://yandex.ru/dev/autoru/doc/ru/reference/dealer/chats/campaigns/list.md
---
> **Documentation Index:** Fetch the complete configuration index at https://yandex.ru/dev/autoru/doc/ru/llms.txt


# POST dealer/chats/campaigns/list

Позволяет получить список рассылок из отчета за заданный период или полный список рассылок.
...
POST https://apiauto.ru/1.0/dealer/chats/campaigns/list
...

{
  "filter": {
    "campaign_ids": ["string"],
    "offers_count_limit": 3,
    "offer_id": "2001969671-c1c9b1e8",
    "vin": "3N1CN7AP9FL320476",
...
{% include notitle [filter](../../../../_includes/params/campaigns-435f0a37c701.md#filter) %}

 
:   {% include notitle [campaign_ids](../../../../_includes/params/campaigns-435f0a37c701.md#campaign_ids) %}

    {% include notitle [offers_count_limit](../../../../_includes/params/campaigns-435f0a37c701.md#offers_count_limit) %}

    {% include notitle [offer_id](../../../../_includes/params/campaigns-435f0a37c701.md#offer_id) %}

    {% include notitle [vin](../../../../_includes/params/campaigns-435f0a37c701.md#vin) %}
    ...
    {% include notitle [spent](../../../../_includes/params/campaigns-435f0a37c701.md#spent) %}

    {% include notitle [created_period](../../../../_includes/params/campaigns-435f0a37c701.md#created_period) %}
...
{% include notitle [pagination](../../../../_includes/params/campaigns-435f0a37c701.md#pagination) %}

 
:   {% include notitle [page](../../../../_includes/params/campaigns-435f0a37c701.md#page) %}

    {% include notitle [page_size](../../../../_includes/params/campaigns-435f0a37c701.md#page_size) %}
...
"campaigns": [
  {
    ...
    "all_offers_count": 0,
    "offers": [], 
    "created_at": "2026-03-26T15:04:33.292Z",
    "active_from": "2026-03-26T15:04:33.292Z",
    "active_to": "2026-03-26T15:04:33.292Z",
    "send_from": "2026-03-26T15:04:33.292Z",
    "send_to": "2026-03-26T15:04:33.292Z",
    "template": {
        "id": 0,
    ...
    "promocode": "string",
    "promocode_valid_to": "2026-03-26T15:04:33.292Z",
    "percentage": 0,
    "kopeck": 0,
    "verba": {
        "verba": [
...
:   {% include notitle [id](../../../../_includes/params/campaigns-435f0a37c701.md#id) %}
    ...
     
    :   {% include notitle [page_num](../../../../_includes/params/campaigns-435f0a37c701.md#page_num) %}

        {% include notitle [page_size](../../../../_includes/params/campaigns-435f0a37c701.md#page_size) %}

        {% include notitle [total_count](../../../../_includes/params/campaigns-435f0a37c701.md#total_count) %}

        {% include notitle [total_page_count](../../../../_includes/params/campaigns-435f0a37c701.md#total_page_count) %}
